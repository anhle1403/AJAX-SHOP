...
class CategoryProductController extends Controller
{
    ...
    public function all_category_product(){
        ...
        return view('admin.dashboard')->with('admin.all_category_product', $manager_category_product);
    ...
    public function save_category_product( Request $request)
    {
        ...
        $data['created_at'] = $request ->category_product_time;
    ...
    public function unactive_category_product($category_product_id){
        ...
        Session::put('message','Kích hoạt hiển thị danh mục thành công');
    ...
    public function edit_category_product($category_product_id){
        ...
        return view('admin.dashboard')->with('admin.edit_category_product', $manager_category_product);
