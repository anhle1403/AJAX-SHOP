            ...
            <table class="table table-bordered">
              ...
              <tbody style="text-align: center">
                ...
                <tr class="table-info">
                  ...
                  ?>
                    <a href="{{URL::to('/unactive-brand-product/'.$cate_pro->brand_id)}}"><img src="https://img.icons8.com/color/48/000000/closed-eye.png"/></a>
                  <?php  
                  }else{
                  ?>
                    <a href="{{URL::to('/active-brand-product/'.$cate_pro->brand_id)}}"><img src="https://img.icons8.com/bubbles/48/000000/visible--v2.png"/></a>
                  <?php
                    }
                  ?>
                  </td>
                  ...
                  <td style="text-align: center">
                    <a href="{{URL::to('/edit-brand-product/'.$cate_pro->brand_id)}}" class="active" ui-toggle-class=""><img src="https://img.icons8.com/external-bearicons-gradient-bearicons/64/000000/external-setting-essential-collection-bearicons-gradient-bearicons.png" style="" id="Sua"/></a>
                    <a onclick="return confirm('Are you sure to delete ?')" href="{{URL::to('/delete-brand-product/'.$cate_pro->brand_id)}}"><img src="https://img.icons8.com/plasticine/64/000000/filled-trash.png" style="height: 35px;width: 36px;"/></a>
                  </td>
                </tr>
                @endforeach
              </tbody>
