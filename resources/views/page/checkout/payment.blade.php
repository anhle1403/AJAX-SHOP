                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="shoping__cart__btns">
                                    <a href="{{URL::to('/trangchu')}}" class="primary-btn cart-btn">CONTINUE SHOPPING</a>
                            ...
                            <div class="col-lg-6">
                                <div class="shoping__checkout">
                                    ...
                                    <ul><b>Chọn hình thức thanh toán</b></ul>
                                    <ul>
                                        ...
                                        <div class="checkout__input__checkbox">
                                            <label for="paypal1">
                                                Tiền Mặt
                                                <input type="checkbox" name="payment_option" value="2" required id="paypal1">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        <div class="checkout__input__checkbox">
                                            <label for="paypal">
                                                Paypal
                                                <input type="checkbox" name="payment_option" value="3" id="paypal">
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
